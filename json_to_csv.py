...
def json_to_csv(json_data):
    ...
    for item in json_data:
        csv_data.append([item['title'], item['description'], item['videoUrl'], item['thumbnailUrl'], item['genre'], item['duration']])
    return csv_data
...
with open('movies.csv', 'w', newline='') as file:
    ...
    writer.writerow(['title', 'description', 'videoUrl', 'thumbnailUrl', 'genre', 'duration'])
